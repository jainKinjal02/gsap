...
const GsapTimeline = () => {
  ...
  // adding different forms of animation to the same object for different durations in a continuous manner
  // if you see there are 3 animation on yellow box
  // and then adding the play pause on click on button using timeline
